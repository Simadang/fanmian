						...
						<div class="user-infoPic">
							...
							<div class="info-m">
								...
								<div class="u-safety">
									<a href="safety.html">
									 账户安全
									<span class="u-profile"><i class="bc_ee0000" style="width: 60px;" width="0">{{ $info[0]['code'] }}分</i></span>
									</a>
								</div>
							</div>
						</div>
						...
						<div class="check">
							<ul>
								...
								<li>
									...
									<div class="fore3">
										<a href="setpay.html">
											<div class="am-btn am-btn-secondary" disabled>立即启用</div>
										</a>
									</div>
								</li>
								<li>
								...
								<li>
									...
									<div class="fore3">
										<a href="{{ url('safety/email') }}">
										@if($user['email'])
											<div class="am-btn am-btn-secondary" disabled >换绑</div>
								...
								<li>
									...
									<div class="fore3">
										<a href="idcard.html">
											<div class="am-btn am-btn-secondary" disabled>认证</div>
										</a>
									</div>
								</li>
								<li>
