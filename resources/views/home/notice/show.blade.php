...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<div class="topMessage favorite">
						...
						<div class="nav white">
							...
							<div class="search-bar pr">
								<ul>
									<li style="font-size:30px; color:red;">公告名:<span style="font-size:25px; color:black">{{$name}}</span></li>
								</ul>
							</div>
						</div>
	...
	<body class="am-container header">
		...
		<div style="margin-top:50px;">
			...
			<ul>
				<li style="font-size:20px;color:red">公告内容:<span style="font-size:35px; color:black">{!!$content!!}</span></li>
				<li style="font-size:20px;color:red">公告时间:<span style="font-size:15px; color:black">{!!$ctime!!}</span></li>
