...
<div class="mws-panel grid_8 mws-collapsible">
    ...
    <div class="mws-panel-inner-wrap"><div class="mws-panel-body no-padding">
        ...
        <table class="mws-table mws-datatable dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
            <thead>
                <tr role="row"><th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending"  style="width: 70px;">权限ID</th>
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 157px;">权限名</th>
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 157px;">权限说明</th>
        	...
        	<tr class="even" style='text-align: center;'>
                ...
                <td class=" ">
                    <span class="btn-group">
                        <a href="/admin/permission/{{$v->id}}/edit" class="btn btn-small"><i class="icon-pencil"></i></a>
                        <a href="javascript:void(0)" class="btn btn-small" onclick="delPermission({{ $v['id'] }})"><i class="icon-trash"></i></a>
                    </span>
                </td>
            </tr>
            @endforeach
