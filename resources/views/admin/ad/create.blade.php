...
<div class="mws-panel grid_8">
      ...
      {{--<p style="color:red">用户名错误</p>--}}
                    	<form class="mws-form" action="{{ url('admin/ad') }}" method="post" id="ad_form" enctype="multipart/form-data">
                    		...
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                                    ...
                                    <input type="hidden" name="id" value="{{$id}}">
                                        <input class="small" type="text" name="name"  placeholder="广告名称">
                                        <input class="small" type="text" name="content"   placeholder="广告简介">
                                        <input class="small" type="text" name="url"   placeholder="广告链接">
                                        <input class="small" type="hidden" name="pic"  id="pic">
                                                <br><br>
                                    <br><br>
                                            {{--文件上传插件--}}
...
//                            var myform = document.getElementById('art_from');
            var formData = new FormData($('#ad_form')[0]);
